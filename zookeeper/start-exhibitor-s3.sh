...
java -jar target/exhibitor-war-1.0-jar-with-dependencies.jar -c s3 --s3credentials s3creds.properties --s3config ZK-config:zoo.cfg --hostname $local_ip >> exhibitor.out &
